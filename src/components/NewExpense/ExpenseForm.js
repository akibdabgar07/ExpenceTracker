...
const ExpenseForm = (props) => {
    ...
    const submitHandler = (event) => {
        event.preventDefault(); // use this function page not referesh
        ...
        if(localstorageItems == null){
            ...
            formDataArr.push(localstorageItems);
        }
    ...
    return (
        <form onSubmit={submitHandler}>
            <div className="new-expense__controls">
                ...
                <div className="new-expense__control">
                    <label>Amount</label>
                    <input type="text"  value={enteredAmount}   onChange={amountChangeHandler} required />
                </div>
                <div className="new-expense__control">
                    <label>Date</label>
